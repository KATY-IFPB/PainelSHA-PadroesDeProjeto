...
public class HidrometroFacade {
	 ...
	 *//*
		 * public boolean removerHidrometro(String id) { if
		 * (!hidrometros.containsKey(id)) {
		 * System.out.println("Erro: Hidrômetro com ID " + id + " não encontrado!");
		 * return false; } Hidrometro hidrometro = hidrometros.get(id); if
		 * (hidrometro.estaRodando()) { hidrometro.pararLeitura(); }
		 * hidrometros.remove(id); System.out.println("Hidrômetro " + id +
		 * " removido com sucesso!"); return true; }
		 */
	 ...
	 */
	/*
	 * public Hidrometro getHidrometro(String id) { return hidrometros.get(id); }
	 */
	 ...
	 */
	/*
	 * public int quantidadeHidrometros() { return hidrometros.size(); }
	 */
	 ...
	 */
	/*
	 * public boolean existeHidrometro(String id) { return
	 * hidrometros.containsKey(id); }
	 */
	 ...
	 */
	/*
	 * public boolean iniciarHidrometro(String id) { Hidrometro hidrometro =
	 * hidrometros.get(id); if (hidrometro == null) {
	 * System.out.println("Erro: Hidrômetro com ID " + id + " não encontrado!");
	 * return false; } if (!hidrometro.estaRodando()) { hidrometro.start(); return
	 * true; } System.out.println("Hidrômetro " + id + " já está em execução!");
	 * return false; }
	 */
	 ...
	 */
	/*
	 * public boolean pararHidrometro(String id) { Hidrometro hidrometro =
	 * hidrometros.get(id); if (hidrometro == null) {
	 * System.out.println("Erro: Hidrômetro com ID " + id + " não encontrado!");
	 * return false; } if (hidrometro.estaRodando()) { hidrometro.pararLeitura();
	 * return true; } System.out.println("Hidrômetro " + id + " já está parado!");
	 * return false; }
	 */
	 ...
	 *//*
		 * public void pararTodosHidrometros() { for (Map.Entry<String, Hidrometro>
		 * entry : hidrometros.entrySet()) { if (entry.getValue().estaRodando()) {
	 ...
	 * System.out.println("Total: " + hidrometros.size() + " hidrômetro(s)"); for
	 * (Map.Entry<String, Hidrometro> entry : hidrometros.entrySet()) { String id =
	 * entry.getKey(); Hidrometro h = entry.getValue(); String status =
	 * h.estaRodando() ? "RODANDO" : "PARADO";
	 * System.out.printf("ID: %s | Status: %s | Leitura: %.3f m³%n", id, status,
	 * h.getLeituraAtual()); }
	 * System.out.println("==============================\n"); }
	 */
//====================================================================================== metodos usados no projeto
	...
	public void adicionarHidrometro(Double leituraInicial) {
		...
		hidrometroDao.adicionarHidrometro(hidrometro);
	}
